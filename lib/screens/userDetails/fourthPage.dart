...
class _FourthPageState extends State<FourthPage> {
  ...
  TextEditingController alumniController = TextEditingController();
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      GestureDetector(
                                        onTap: (){
                                          studentController.text = 'Student';
                                  ...
                                  Center(
                                    child: GestureDetector(
                                      onTap: (){
                                        outsiderpController.text = 'Outsider';
